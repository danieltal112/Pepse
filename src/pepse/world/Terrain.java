...
public class Terrain {
    ...
    public Terrain(GameObjectCollection gameObjects,
        ...
        this.groundHeightAtX0 = windowDimensions.y() * HEIGHT_AT_X0_FACTOR;
    }
    ...
    public float groundHeightAt(float x) {
        ...
        if (x - Block.SIZE > Block.SIZE && x + Block.SIZE < windowDimensions.x()) {
            if (calcGroundHeightAt(x - Block.SIZE) < result + Block.SIZE
                    && calcGroundHeightAt(x + Block.SIZE) < result + Block.SIZE)
