package pepse.world;
/* Given the advice at page 6 of ex_5 instructions, the following
code is loosely based on a perlin-noise
...
public class PerlinNoise {
    ...
    private void init() {
        ...
        int[] permutation = new int[]{151, 160, 137, 91, 90, 15,
                131, 13, 201,
                95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69,
                142, 8, 99,
                37, 240, 21, 10, 23, 190, 6, 148, 247, 120, 234, 75,
                0, 26,
                197, 62, 94, 252, 219, 203, 117, 35, 11, 32, 57, 177,
                33, 88,
                237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68,
                175, 74,
                165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231,
                83, 111,
                229, 122, 60, 211, 133, 230, 220, 105, 92, 41, 55,
                46, 245, 40,
                244, 102, 143, 54, 65, 25, 63, 161, 1, 216, 80, 73,
                209, 76,
                ...
                138, 236,
                205, 93, 222, 114, 67, 29, 24, 72, 243, 141, 128,
                195, 78, 66,
                215, 61, 156, 180};
    ...
    /**
     * The function will return the average of two functions,
     * where the first parameter have twice
    ...
    public float noise(float x) {
        ...
        while (size >= 1) {
            value += smoothNoise((x / size), (0f / size),
                    (0f / size)) * size;
            size /= 2.0;
        }

        float noiseFactor = (value / initialSize);
        float sinFactor = (float) (Math.sin(SIN_ENLARGE_FACTOR
                * (x + seed)));
